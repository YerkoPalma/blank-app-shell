...
var yo = _interopDefault(require('yo-yo'));
...
var HomeView = params => yo`<h1>Home</h1>`;

var AboutView = params => yo`<h1>About</h1>`;

var UserView = params => yo`<h1>User ${JSON.stringify(params)}</h1>`;

document.addEventListener('DOMContentLoaded', function (e) {
  var oldHeader = document.querySelector('header');
  var newHeader = yo.update(oldHeader, header);
